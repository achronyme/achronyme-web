...
test "$("$install_root/bin/ach" --version)" = "ach 0.0.1"
...
grep -qx \
    ...
    "$request_log"
grep -qx \
    "https://github.com/achronyme/achronyme/releases/download/v0.0.1/$artifact.tar.gz" \
    "$request_log"
grep -qx \
    "https://github.com/achronyme/achronyme/releases/download/v0.0.1/$artifact.tar.gz.sha256" \
    "$request_log"
