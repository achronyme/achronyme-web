...
reveal="$project_root/src/components/ScrollReveal.astro"
...
grep -Fq 'id="release-status"' "$landing"
grep -Fq 'id="capabilities"' "$landing"
grep -Fq 'id="proof-trust"' "$landing"
grep -Fq '"releaseStatus"' "$english"
grep -Fq '"releaseStatus"' "$spanish"
grep -Fq '"capabilities"' "$english"
grep -Fq '"capabilities"' "$spanish"
...
grep -Fq "element.classList.add('reveal-pending')" "$reveal"
grep -Fq "element.getBoundingClientRect()" "$reveal"
grep -Fq '.reveal.reveal-pending {' "$global_css"
