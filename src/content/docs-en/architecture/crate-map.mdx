...
| `ir-forge` | `ir-forge/` | ProveIR templates, AST→ProveIR compiler, Lysis lift walker |
...
| `lysis` | `lysis/` | Third VM, structural template instantiator with hash-consing — **in progress** |
