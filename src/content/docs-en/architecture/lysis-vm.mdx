...
File: `crates/ir-forge/src/lysis_lift/mod.rs`. Five stages:
...
File: `crates/lysis/src/bytecode/opcode.rs`.
...
File: `crates/lysis/src/execute/mod.rs`. Outer loop over frames + inner step:
...
| Header (v1/v2) | `crates/lysis/src/header.rs` |
