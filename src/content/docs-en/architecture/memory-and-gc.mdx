...
| `fields` | `FieldElement` | 32 bytes (BN254 Montgomery form, default backend) |
...
| FieldElement | `memory/src/field/` |
| GC trait & mark_roots | `akron/src/machine/gc.rs` |
| VM (GC trigger) | `akron/src/machine/vm.rs` |
| GC stats native | `akron/src/stdlib/core.rs` |
