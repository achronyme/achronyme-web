...
The CLI exposes independent limits for tasks, resources, simultaneously live
task scopes, channels, retained results, pending native requests, blocking
workers, and the blocking queue. For example:
