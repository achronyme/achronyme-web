...
The currently published stable version is `0.1.0`. Pin it explicitly when
...
exact published revision when reproducing 0.1.0 behavior:
...
backends. In 0.1.0, proof generation fails unless you choose
