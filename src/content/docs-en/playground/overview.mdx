---
title: Playground
description: Write, run, and prove Achronyme programs from your browser.
---
...
- Editor intelligence (diagnostics, completions, hover, go-to-definition, symbols) runs locally in the browser via WASM with zero latency; compilation, execution, and proving are delegated to the server
- Session management and file backup via localStorage
