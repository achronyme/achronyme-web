...
### New: E2E Groth16 proofs for circomlib templates

Full pipeline verified end-to-end for real circomlib circuits: **Num2Bits(8)** (17 constraints), **IsZero()** (4 constraints), and **LessThan(8)** (component composition with Num2Bits inlining). Each generates and verifies a Groth16 proof on BN254.
