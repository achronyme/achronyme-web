...
> The implementation is merged, but `v0.1.0` has not been tagged or published.
> The latest published core release remains `v0.0.1` until the production
> ceremony and interoperability gate below is complete.
...
- Publication remains gated on the independently contributed production
  ceremony and its recorded public-beacon evidence.
