---
title: Playground
description: Escribe, ejecuta y prueba programas Achronyme desde tu navegador.
---
...
- La inteligencia del editor (diagnósticos, completado, hover, ir-a-definición, símbolos) corre localmente en el navegador vía WASM con cero latencia; la compilación, ejecución y generación de pruebas se delegan al servidor
- Gestión de sesiones y respaldo de archivos vía localStorage
