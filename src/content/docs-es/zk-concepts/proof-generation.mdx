...
> **Limitación conocida:** el setup confiable de Groth16 es **solo para desarrollo**. Las claves de prueba y verificación se generan localmente con un CSPRNG (`OsRng`), no mediante una ceremonia multipartita. Para un despliegue de producción necesitas una ceremonia real — ingerir Powers of Tau externos es el camino planificado y aún no está conectado.
