...
## 0.1.0 - candidato de release (sin publicar)

> La implementacion esta fusionada, pero `v0.1.0` no ha sido etiquetado ni
> publicado. El ultimo release publicado del core sigue siendo `v0.0.1` hasta
> completar el gate de ceremonia de produccion e interoperabilidad descrito
> abajo.
...
- La publicacion sigue bloqueada hasta registrar la contribucion independiente
  de la ceremonia de produccion y su evidencia de beacon publico.
