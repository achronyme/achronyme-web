...
### Nuevo: pruebas Groth16 E2E para templates de circomlib

Pipeline completo verificado end-to-end para circuitos reales de circomlib: **Num2Bits(8)** (17 restricciones), **IsZero()** (4 restricciones) y **LessThan(8)** (composición de componentes con inlining de Num2Bits). Cada uno genera y verifica una prueba Groth16 sobre BN254.
