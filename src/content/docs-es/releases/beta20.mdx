...
Sin cambios rompedores para codigo `.ach` existente. Los bloques `prove {}` siguen funcionando. El bytecode `.achb` existente compilado bajo beta.19 requiere recompilacion ([el formato de ProveIR subio a v5](/es/docs/architecture/prove-ir/#tipos-contenedores)).
