...
**Modo circuito** (`ach circuit`): Compila a restricciones aritméticas sobre un campo primo configurable (BN254, BLS12-381 o Goldilocks via `--prime`). Sin bucles en tiempo de ejecución, sin E/S; todo se desenrolla y aplana en un sistema de restricciones para pruebas de conocimiento cero.
...
<AchDiagram svg={introPipelineSvgEs} ariaLabel="Vista general de los modos de ejecución de Achronyme" />

## Estado

- 3,695 pruebas unitarias + 162 pruebas E2E de integración
