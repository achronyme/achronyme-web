...
- **Paridad de constraints (o mejor)**: despues del pase O1 de Achronyme mas propagacion de constantes en tiempo de compilacion, cada template de circomlib benchmarkeado (Num2Bits, LessThan, Poseidon, Pedersen, EscalarMulAny, MiMCSponge) iguala o supera el output O1 de circom 2.x. Ve [Modo Circuito](/docs/circom/circuit-mode/#notas-de-costo-de-constraints) para la tabla completa.
