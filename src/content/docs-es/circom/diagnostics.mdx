...
| `template argument must be an integer literal` | Restriccion de las llamadas en modo VM (ver [Limitaciones del Modo VM](/docs/circom/limitations/#limitaciones-del-modo-vm)). |
