...
Para configurarlo en todo el proyecto, declara los mismos directorios en `[circom].libs`. `ach run`, `ach circuit` y `ach circom` consumen esa lista; las entradas `-l/--lib` del CLI añaden directorios extra para una sola invocación.
