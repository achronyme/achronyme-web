...
| `ir-forge` | `ir-forge/` | Plantillas ProveIR, compilador AST→ProveIR, walker del lift de Lysis |
...
| `lysis` | `lysis/` | Tercera VM, instanciador estructural de plantillas con hash-consing — **en progreso** |
