...
El workspace de Achronyme contiene 10 crates. Todos comparten la misma versión, edición 2021.
...
| `vm` | `vm/` | Máquina virtual basada en registros, intérprete de bytecode, despacho de métodos por prototipos |
