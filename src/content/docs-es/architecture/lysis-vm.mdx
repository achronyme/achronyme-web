...
Archivo: `crates/ir-forge/src/lysis_lift/mod.rs`. Cinco etapas:
...
Archivo: `crates/lysis/src/bytecode/opcode.rs`.
...
Archivo: `crates/lysis/src/execute/mod.rs`. Loop externo sobre frames + paso interno:
