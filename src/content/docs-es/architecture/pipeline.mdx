...
Para `ach run`, el AST se compila a bytecode para la VM basada en registros (42 opcodes). Un optimizador de bytecode de 3 pases se ejecuta después de la compilación:
