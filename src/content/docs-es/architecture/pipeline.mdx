...
Achronyme compila el mismo lenguaje fuente a través de tres caminos distintos: **Modo VM** para ejecución general, **Modo circuito** para generación de restricciones vía `ach circuit`, y **Modo prove** para generación de pruebas en línea vía bloques `prove {}`.
