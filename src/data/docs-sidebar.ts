...
export const sidebarConfig: SidebarConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Grammar & Lexer', slug: 'architecture/grammar', translations: { es: 'Gramatica y Lexer' } },
      { label: 'AST Reference', slug: 'architecture/ast-reference', translations: { es: 'Referencia del AST' } },
      { label: 'IR & Optimization', slug: 'architecture/ir-and-optimization', translations: { es: 'IR y Optimizacion' } },
      { label: 'ProveIR', slug: 'architecture/prove-ir' },
